...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently building a Expense tracker webApp with Next.js.",
    description: "The Inside Scoop",
    className: "md:col-span-3 md:row-span-2",
    imgClassName: "absolute right-0 bottom-0 lg:w-8/12 w-60",
...
export const workExperience = [
  {
    ...
    desc: "6 Months | Assisted in the development of various web-based applications using React.js, Node.js enhancing interactivity and performance.",
